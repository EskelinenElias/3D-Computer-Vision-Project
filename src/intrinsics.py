"""
Intrinsic camera calibration — recover the intrinsic matrix K.

K is a property of the lens + sensor, independent of any scene. Only needs to
be run once per camera (valid until you zoom or swap optics).

Two backends:
- "zhang": checkerboard images at different board orientations.
- "dlt":   single image + manual 2D/3D correspondences.
"""
