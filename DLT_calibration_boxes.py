...
def calibrate_DLT_boxes(extrinsic_img_input):
    ...
    points_2d = select_points(extrinsic_img_cv)
    points_2d = np.array(points_2d) * 2

    points_3d = np.array([
        [ 0.0,  0.0, 0.0], #origo
        [-28.0,  0.0, 0.0], #left cube bottom
        [-28.0,  0.0, 4.0], #left cube top
        [-28.0, 20.0, 0.0], #middle cube bottom
        [-28.0, 20.0, 4.0], #middle cube top
        [ 0.0, 20.0, 0.0], #right cube left bottom
        [ 0.0, 20.0, 4.0], #right cube left top
        [ 4.0, 20.0, 0.0], #right cube right bottom
        [ 4.0, 20.0, 4.0], #right cube right top
        ])
